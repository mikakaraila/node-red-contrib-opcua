...
// export function getEventSubscriptionParameters(timeMilliseconds: number) {
//     return {
...
//     };
// };
// export function getSubscriptionParameters(timeMilliseconds: number) {
//     return {
//         requestedPublishingInterval: timeMilliseconds || 100,
...
// */
// export function convertToString(inType: string) {
